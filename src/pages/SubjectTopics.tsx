...
const SubjectTopics: React.FC = () => {
  ...
  // Group contents by topic/title
  const topicGroups = contents.reduce((acc, content) => {
    const topic = content.topic_name || content.title || 'Outros';
    if (!acc[topic]) {
      acc[topic] = [];
    }
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {loading ? (
            ...
            Object.entries(topicGroups).map(([topic, topicContents]) => {
