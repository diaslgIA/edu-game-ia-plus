      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {loading ? (
            ...
            <div className="text-white text-center py-8">Nenhum tópico disponível ainda.</div>
          ) : (
            contents.map((content) => {
              const topicQuestions = getQuestionsByTopic(content.topic_name || content.title || '');
              ...
              return (
                <div key={content.id} className="space-y-4">
                  ...
                  {topicQuestions.length > 0 && (
                    <div
                      onClick={() => {
                        setSelectedTopic(content.topic_name || content.title || '');
                        setShowQuiz(true);
                      }}
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-bold text-white text-lg mb-1">Quiz de {content.topic_name || content.title || 'Tópico'}</h3>
